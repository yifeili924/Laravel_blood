...
<div class="sample_dashboard">
                    ...
                    <ul>
                        ...
                        @else
                            ...
                            @if( Auth::user()->hasRole('user') )
                                <li>
                                    <a href="{{ route('activated.protected') }}">Questions</a>
                                </li>
                            @endif
    ...
    <div id="signModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            ...
            <form accept-charset="UTF-8" action="{{url('register')}}" class="require-validation"
                  data-cc-on-file="false" data-stripe-publishable-key="pk_test_ETYfMh0RAH7FAkidtf3KAxOz" id="payment-form" method="post">
