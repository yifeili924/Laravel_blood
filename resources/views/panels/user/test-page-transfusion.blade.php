...
@section('content')
	...
	<div class="panel-content">
		...
		<div class="page-content">
			<div class="subtitle">
				<span>Transfusion {{$result->id}}: &nbsp;</span>
			...
			<div class="row no-padding">
				...
				<div class="morp-actions">
					<div class="btns">
                        ...
                        ?>
						<button class="link-feedback" data-toggle="modal" data-target="#fbModal" type="button" style="float: right" data-question-id="{{$result->id}}" data-question-type="transfusion">Feedback</button>
					</div>
				</div>
			</div>
			{!! Form::close() !!}
		...
		{{--<div class="form-group">--}}
			...
			{{--<input type="hidden" name="questionType" value="transfusion">--}}
