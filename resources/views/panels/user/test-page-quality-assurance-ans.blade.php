		...
		<div class="page-content">
			...
			<div class="row no-padding">
				...
				<div class="btns">
					...
					<a class="link-feedback" data-toggle="modal" data-target="#fbModal" type="button" style="float: right" data-question-id="{{$result->id}}" data-question-type="quality-ans">Feedback</a>
				</div>
				{!! Form::close() !!}
			</div>
		</div>
