			...
			<div class="row no-padding">
				...
				<div class="morp-actions">
					<div class="btns">
						...
						<button class="link-feedback" data-toggle="modal" data-target="#fbModal" type="button" style="float: right" data-question-id="{{$result->id}}" data-question-type="haemothromb-ans">Feedback</button>
					</div>
				</div>
				{!! Form::close() !!}
			</div>
