...
{!! Form::open(['url' => url('admin/update-quality-assurance'), 'files'=>true ,'class' => 'form-signin', 'data-parsley-validate' ] ) !!}
  ...
  <div class="form-group">
    <input type="hidden" name="simgs" id="finalimages" value="<?php echo $qualityassurance->selimages ?>">
  ...
  <div class="row selectedImages">
    <?php
      if(!empty($qualityassurance->selimages)) {
        $myname =  $qualityassurance->selimages;
